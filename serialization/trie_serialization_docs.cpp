...
int main(){
    ...
    string path_p1 = "C:\\Users\\Victor Vilanova\\Desktop\\clean_01\\";
    string path_p2 = "C:\\Users\\Victor Vilanova\\Desktop\\clean_02\\";
	ifstream file_p1;
	ifstream file_p2;
	cout << "Running: " << endl;
	file_p1.open(path_desk + "titles_clean_unic.txt");
	string str;
    ...
    fstream serialize;
    serialize.open(path2+"serialization_titles.txt");
